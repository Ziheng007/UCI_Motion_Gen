...
from models.mask_transformer.transformer import MaskTransformer,GroupTransformer
from models.mask_transformer.transformer_trainer import MaskTransformerTrainer
from models.vq.model import RVQVAE
from models.vq.model_group import RVQVAE_Group
...
if __name__ == '__main__':
    ...
    t2m_transformer = GroupTransformer(code_dim=vq_opt.code_dim,
                                      cond_mode='text',
