...
GT_SMPL = body_material(0.0, 0.749, 1.0)
GEN_SMPL = body_material(0.0, 0.749, 1.0)
...
class Meshes:
    ...
    #     import matplotlib
    #     # light pink
    #     start_color = (1.0, 0.7137, 0.7569)
        
    #     # vibrant pink
    #     end_color = (1.0, 0.4118, 0.7059)
    #     # green
    #     # start_color = (0.5647, 0.9333, 0.5647)
    #     end_color = (0.0, 1.0, 0.0)

        
    #     # frac is used to create 渐变 image. frac = cur_frame / total_frame
    #     rgbcolor = tuple(
    ...
    def get_sequence_mat(self, frac):
        ...
        # sky blue
        # start_color = (0.529, 0.808, 0.980)

        # # bright blue
        # end_color = (41/255, 95/255, 235/255)
