...
def parse_args(phase="train"):
    ...
    if phase == "render":
        ...
        group.add_argument(
            ...
            type=str,
            required=True,
            help="task name which will be used to create folder to place rendered videos and frames",
        )
    ...
    if phase == "render":
        ...
        cfg.RENDER.TASK_NAME = params.task_name
        cfg.RENDER.START = params.start
        cfg.RENDER.END = params.end
        cfg.RENDER.DEVICE = params.device
        cfg.RENDER.SAVE = params.save_dir
